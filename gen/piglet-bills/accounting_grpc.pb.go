...
const (
	PigletBills_CreateBill_FullMethodName     = "/accounting.PigletBills/CreateBill"
	PigletBills_GetAllAccounts_FullMethodName = "/accounting.PigletBills/GetAllAccounts"
	PigletBills_GetAllGoals_FullMethodName    = "/accounting.PigletBills/GetAllGoals"
	PigletBills_GetBill_FullMethodName        = "/accounting.PigletBills/GetBill"
	PigletBills_UpdateBill_FullMethodName     = "/accounting.PigletBills/UpdateBill"
	PigletBills_DeleteBill_FullMethodName     = "/accounting.PigletBills/DeleteBill"
	PigletBills_FixBillSum_FullMethodName     = "/accounting.PigletBills/FixBillSum"
)
...
type PigletBillsClient interface {
	...
	GetAllAccounts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetSomeBillsResponse, error)
	GetAllGoals(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetSomeBillsResponse, error)
...
func (c *pigletBillsClient) CreateBill(ctx context.Context, in *CreateBillRequest, opts ...grpc.CallOption) (*BillResponse, error) {
	...
	err := c.cc.Invoke(ctx, PigletBills_CreateBill_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pigletBillsClient) GetAllAccounts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetSomeBillsResponse, error) {
	out := new(GetSomeBillsResponse)
	err := c.cc.Invoke(ctx, PigletBills_GetAllAccounts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pigletBillsClient) GetAllGoals(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetSomeBillsResponse, error) {
	out := new(GetSomeBillsResponse)
	err := c.cc.Invoke(ctx, PigletBills_GetAllGoals_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pigletBillsClient) GetBill(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*BillResponse, error) {
	out := new(BillResponse)
	err := c.cc.Invoke(ctx, PigletBills_GetBill_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pigletBillsClient) UpdateBill(ctx context.Context, in *UpdateBillRequest, opts ...grpc.CallOption) (*BillResponse, error) {
	out := new(BillResponse)
	err := c.cc.Invoke(ctx, PigletBills_UpdateBill_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pigletBillsClient) DeleteBill(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*SuccessResponse, error) {
	...
	err := c.cc.Invoke(ctx, PigletBills_DeleteBill_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pigletBillsClient) FixBillSum(ctx context.Context, in *FixBillSumRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, PigletBills_FixBillSum_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PigletBillsServer interface {
	...
	GetAllAccounts(context.Context, *emptypb.Empty) (*GetSomeBillsResponse, error)
	GetAllGoals(context.Context, *emptypb.Empty) (*GetSomeBillsResponse, error)
...
func (UnimplementedPigletBillsServer) GetAllAccounts(context.Context, *emptypb.Empty) (*GetSomeBillsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllAccounts not implemented")
}
func (UnimplementedPigletBillsServer) GetAllGoals(context.Context, *emptypb.Empty) (*GetSomeBillsResponse, error) {
...
func _PigletBills_CreateBill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PigletBills_CreateBill_FullMethodName,
	}
...
func _PigletBills_GetAllAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PigletBills_GetAllAccounts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PigletBillsServer).GetAllAccounts(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PigletBills_GetAllGoals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PigletBills_GetAllGoals_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PigletBillsServer).GetAllGoals(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PigletBills_GetBill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PigletBills_GetBill_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PigletBills_UpdateBill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PigletBills_UpdateBill_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PigletBills_DeleteBill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PigletBills_DeleteBill_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PigletBills_FixBillSum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PigletBills_FixBillSum_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
